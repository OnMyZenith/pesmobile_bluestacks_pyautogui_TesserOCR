...
def ContRen():
    ...
    sys.stdout=open("Contract4Legends.0Output.txt", "a")
    ...
    while z < 1:
        ...
        if (pyautogui.locateCenterOnScreen('CF_MVB.png') is not None):
            print("Found Squad2")
            print()
            print()
        ...
        elif (pyautogui.locateCenterOnScreen('CF_Torres.png') is not None):
            print("Found Squad1")
            print()
            print()
            #winsound.Beep(700, 100)
