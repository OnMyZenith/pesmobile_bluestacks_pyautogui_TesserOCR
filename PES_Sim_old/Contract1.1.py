...
def ContRen():
    ...
    sys.stdout=open("Contract1.1Output.txt", "a")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('ContRen.png') is not None):
                                    ...
                                    print("Couldn't find ContRen, looking for Retry, clicking if found")
                                ...
                                if (pyautogui.locateCenterOnScreen('GP.png') is not None):
                                    ...
                                    while e < 1:
                                        ...
                                        if (pyautogui.locateCenterOnScreen('Renew.png') is not None):
                                            ...
                                            print("Couldn't find Renew, looking for Retry, clicking if found")
                                            pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                            winsound.Beep(2000, 100)
                                            time.sleep(2)
                                            pyautogui.mouseUp()
                                    ...
                                    while e < 1:
                                        ...
                                        if (pyautogui.locateCenterOnScreen('RenewedOK.png') is not None):
                                            ...
                                            print("Couldn't find RenewedOK or RenewedOK_Alt, looking for Retry, clicking if found")
                                            pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                            winsound.Beep(2000, 100)
                                            time.sleep(2)
                                            pyautogui.mouseUp()
                                    ...
                                    while e < 1:
                                        ...
                                        if (pyautogui.locateCenterOnScreen('X.png') is not None):
                                            ...
                                            print("Couldn't find X, looking for Retry, clicking if found")
                                            pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                            winsound.Beep(2000, 100)
                                            time.sleep(2)
                                            pyautogui.mouseUp()
                                            
                                            print("Going back to look for X")
                                    

                                else:
                                    print("Couldn't find GP or ContLimOK, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('LWF_SS_Lavernia.png') is not None):
                                    ...
                                    print("Couldn't find LWF_SS_Lavernia, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for LWF_SS_Lavernia")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('AMF_Redmond.png') is not None):
                                    ...
                                    print("Couldn't find AMF_Redmond, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for AMF_Redmond")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CMF_Llonch.png') is not None):
                                    ...
                                    print("Couldn't find CMF_Llonch, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CMF_Llonch")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CMF_Bordas.png') is not None):
                                    ...
                                    print("Couldn't find CMF_Bordas, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CMF_Bordas")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('DMF_Rimonte.png') is not None):
                                    ...
                                    print("Couldn't find DMF_Rimonte, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for DMF_Rimonte")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('RB_Torrealba.png') is not None):
                                    ...
                                    print("Couldn't find RB_Torrealba, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for RB_Torrealba")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('LB_Coulfield.png') is not None):
                                    ...
                                    print("Couldn't find LB_Coulfield, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for LB_Coulfield")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CB_Legoida.png') is not None):
                                    ...
                                    print("Couldn't find CB_Legoida, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CB_Legoida")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CB_Candemir.png') is not None):
                                    ...
                                    print("Couldn't find CB_Candemir, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CB_Candemir")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('GK_Luiz.png') is not None):
                                    ...
                                    print("Couldn't find GK_Luiz, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for GK_Luiz")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CF_Goios.png') is not None):
                                    ...
                                    print("Couldn't find CF_Goios, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CF_Goios")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('AMF_Castledine.png') is not None):
                                    ...
                                    print("Couldn't find AMF_Castledine, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for AMF_Castledine")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CMF_Bassano.png') is not None):
                                    ...
                                    print("Couldn't find CMF_Bassano, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CMF_Bassano")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CMF_Vrany.png') is not None):
                                    ...
                                    print("Couldn't find CMF_Vrany, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CMF_Vrany")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('DMF_Boia.png') is not None):
                                    ...
                                    print("Couldn't find DMF_Boia, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for DMF_Boia")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('RB_Parada.png') is not None):
                                    ...
                                    print("Couldn't find RB_Parada, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for RB_Parada")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('LB_Soric.png') is not None):
                                    ...
                                    print("Couldn't find LB_Soric, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for LB_Soric")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CB_Rekarte.png') is not None):
                                    ...
                                    print("Couldn't find CB_Rekarte, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CB_Rekarte")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('CB_Gois.png') is not None):
                                    ...
                                    print("Couldn't find CB_Gois, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for CB_Gois")
                        ...
                        while d < 1:
                            ...
                            while c < 1:
                                ...
                                if (pyautogui.locateCenterOnScreen('GK_Nordfeldt.png') is not None):
                                    ...
                                    print("Couldn't find GK_Nordfeldt, looking for Retry, clicking if found")
                                    pyautogui.mouseDown(pyautogui.locateCenterOnScreen('Retry.png'))
                                    winsound.Beep(2000, 100)
                                    time.sleep(2)
                                    pyautogui.mouseUp()
                                    
                                    print("Going back to look for GK_Nordfeldt")
