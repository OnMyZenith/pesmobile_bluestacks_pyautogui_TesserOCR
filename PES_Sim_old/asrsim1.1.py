...
def sim():
    ...
    #sys.stdout=open("asrsim1.1Output.txt", "a")
    ...
    while i == 1 :
        ...
        print("Waiting 10 seconds before looking for ToMatch")
        #coz theres a buffer after finishing a match and this screen
        time.sleep(10)
        ...
        if (pyautogui.locateCenterOnScreen('PContExpOK.png') is not None):
            ...
            while m < 1:
                ...
                if (pyautogui.locateCenterOnScreen('Proceed.png') is not None):
                    ...
                    print("Couldn't find Proceed, looking for Retry, reporting and clicking if found")
                    ...
                    print("Going back to look for Proceed")
        else:
            print("PContExpOK was not found")

        print("Looking for ExtAchOK")
        if (pyautogui.locateCenterOnScreen('ExtAchOK.png') is not None):
            print("Found ExtAchOK")
            winsound.Beep(500, 100)
        ...
        if (pyautogui.locateCenterOnScreen('ContExpOK.png') is not None):
            ...
            while g < 1:
                ...
                if (pyautogui.locateCenterOnScreen('Sign.png') is not None):
                    ...
                    print("Sign was clicked")
                    g = 1                
                    
                else:
                    print("Couldn't find Sign, looking for Retry, reporting and clicking if found")
                    ...
                    print("Going back to look for Sign")
            ...
            while h < 1:
                ...
                if (pyautogui.locateCenterOnScreen('ContExtOK.png') is not None):
                    ...
                    print("ContExtOK was clicked")
                    h = 1                
                    
                else:
                    print("Couldn't find ContExtOK, looking for Retry, reporting and clicking if found")
                    ...
                    print("Going back to look for ContExtOK")
            ...
            while j < 1:
                ...
                if (pyautogui.locateCenterOnScreen('ReqUpOK.png') is not None):
                    ...
                    print("ReqUpOK was clicked")
                    j = 1                
                    
                else:
                    print("Couldn't find ReqUpOK, looking for Retry, reporting and clicking if found")
                    ...
                    print("Going back to look for ReqUpOK")
        ...
        if (pyautogui.locateCenterOnScreen('OKCampStay.png') is not None):
            print("Found OKCampStay")
            winsound.Beep(500, 100)
            ...
            while u < 1:
                ...
                if (pyautogui.locateCenterOnScreen('OKCampBon.png') is not None):
                    ...
                    print("OKCampBon was clicked")
                    u = 1                
                    
                else:
                    print("Couldn't find OKCampBon, looking for Retry, reporting and clicking if found")
                    ...
                    print("Going back to look for OKCampBon")
        else:
            print("OKCampStay was not found")

        print("Looking for OKCampPro")
        if (pyautogui.locateCenterOnScreen('OKCampPro.png') is not None):
            print("Found OKCampPro")
            winsound.Beep(500, 100)
